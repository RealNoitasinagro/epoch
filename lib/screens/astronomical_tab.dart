    ...
    return ListView(
      ...
      children: [
        ...
        TimeStringRow(
          ...
          info: l10n.infoGmst,
          infoLink: l10n.infoLinkGmst,
        ),
        const Divider(height: 40),
        SectionHeader(label: l10n.sectionJulian),
        const SizedBox(height: 8),
        TimeStringRow(
          label: l10n.valueTypeJulianDate,
          value: _formatDecimal(jd, locale, 5),
          info: l10n.infoJulianDate,
          infoLink: l10n.infoLinkJulianDate,
        ),
        const SizedBox(height: 12),
        TimeStringRow(
          label: l10n.valueTypeModifiedJulianDate,
          value: _formatDecimal(mjd, locale, 5),
          info: l10n.infoModifiedJulianDate,
          infoLink: l10n.infoLinkModifiedJulianDate,
        ),
      ],
    );
  }
