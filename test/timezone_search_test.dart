...
void _printDetailsToStderr(String searchTerm, List<TzEntry> loc, showDetails) {
...
void main() {
  ...
  group('IANA timezone deprecated names', () {
    test('Amsterdam', () {
      String ianaZone = 'Europe/Brussels';
  ...
  group('timezone search abbreviations', () {
    test('ACDT', () {
      var searchTerm = 'ACDT';
      var loc = tzDatabase.where( (e) => e.matches(searchTerm) ).toList();
      _printDetailsToStderr(searchTerm, loc, showDetails);
